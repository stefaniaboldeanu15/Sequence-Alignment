...
def run_dataset_to_txt(
    ...
    with open(output_path, "w", encoding="utf-8") as out:
        ...
        out.write(
            f"Scoring: match={match_score}, mismatch={mismatch_score}, "
...
def run_all_datasets() -> None:
    datasets = [
        ("data/raw/globins.fasta", "results/globins_gotoh.txt"),
        ("data/raw/serine_proteases.fasta", "results/serine_proteases_gotoh.txt"),
        ("data/synthetic/synthetic_controls.fasta", "results/synthetic_controls_gotoh.txt"),
    ]
