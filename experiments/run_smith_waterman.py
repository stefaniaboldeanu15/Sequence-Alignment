...
def run_dataset_to_txt(
    ...
    with open(output_file, "w", encoding="utf-8") as out:
        ...
        for idx, (rec1, rec2) in enumerate(pairs, start=1):
            ...
            out.write(f"Local coordinates seq1: {result.start1}..{result.end1}\n")
            out.write(f"Local coordinates seq2: {result.start2}..{result.end2}\n")
    ...
    print(f"Finished: {output_file.resolve()}")


def run_all_datasets() -> None:
    datasets = [
        ("data/raw/globins.fasta", "results/globins_smith_waterman.txt"),
        ("data/raw/serine_proteases.fasta", "results/serine_proteases_smith_waterman.txt"),
        ("data/synthetic/synthetic_controls.fasta", "results/synthetic_controls_smith_waterman.txt"),
    ]
