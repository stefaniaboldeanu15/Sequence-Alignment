...
def run_all_datasets() -> None:
    datasets = [
        ("data/raw/globins.fasta", "results/globins_hirschberg.txt"),
        ("data/raw/serine_proteases.fasta", "results/serine_proteases_hirschberg.txt"),
        ("data/synthetic/synthetic_controls.fasta", "results/synthetic_controls_hirschberg.txt"),
    ]
